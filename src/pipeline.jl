...
const PATH_RESULTS = joinpath(".", "results")
...
function load_dataset_from_path(path::String, n_test::Int)
    ...
    # Assuming df has at least two columns and you want to use the first two for xs and ys
    # Adjust column indexing as per your CSV structure
